...
font-size: 16px;} */}
    ...
    <div class='inside_inner'>
        <ul class='rules'>
            ...
            <li>
                nodefrancias.com is not available to the general public and is
                opened only to the qualified members of nodefrancias.com, the
                use of this site is restricted to our members and to individuals
                personally invited by them. Every deposit is considered to be a
                private transaction between the nodefrancias.com and its Member.
            </li>
            <li>
                As a private transaction, this program is exempt from the US
                Securities Act of 1933, the US Securities Exchange Act of 1934
                and the US Investment Company Act of 1940 and all other rules,
                regulations and amendments thereof. We are not FDIC insured. We
                are not a licensed bank or a security firm.
            </li>
            <li>
                You agree that all information, communications, materials coming
                from nodefrancias.com are unsolicited and must be kept private,
                confidential and protected from any disclosure. Moreover, the
                information, communications and materials contained herein are
                not to be regarded as an offer, nor a solicitation for
                investments in any jurisdiction which deems non-public offers or
                solicitations unlawful, nor to any person to whom it will be
                unlawful to make such offer or solicitation.
            </li>
            <li>
                All the data giving by a member to nodefrancias.com will be only
                privately used and not disclosed to any third parties.
                nodefrancias.com is not responsible or liable for any loss of
                data.
            </li>
            <li>
            ...
            <li>
                nodefrancias.com is not responsible or liable for any damages,
                ...
                to nodefrancias.com that you will not use this site in any
                illegal way and you agree to respect your local, national and
                international laws.
            </li>
            <li>
                Don&#8217;t post bad vote on Public Forums and at Gold Rating
                Site without contacting the administrator of our program FIRST.
                Maybe there was a technical problem with your transaction, so
                please always CLEAR the thing with the administrator.
            </li>
            <li>
            ...
            <li>
                nodefrancias.com reserves the right to accept or decline any
